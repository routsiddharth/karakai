...
(function () {
  ...
  // ---------- basemap: grayscale print positron (swiss ink) ----------
    ...
    for (const l of style.layers) {
      ...
      try {
        if (l.type === "background") {
          l.paint["background-color"] = "#ffffff";
        } else if (l.type === "fill") {
          if (id === "water" || /water|ocean/.test(id)) l.paint["fill-color"] = "#ececec";
          else if (/park|wood|grass|cemetery|pitch|stadium/.test(id)) l.paint["fill-color"] = "#f4f4f4";
          else if (/ice|glacier/.test(id)) l.paint["fill-color"] = "#fafafa";
          else if (/residential|landuse|landcover/.test(id)) l.paint["fill-color"] = "#f7f7f7";
          else if (/building/.test(id)) {
            l.paint["fill-color"] = "#e6e6e6";
            l.paint["fill-outline-color"] = "#d6d6d6";
          }
          else if (/aeroway|pier/.test(id)) l.paint["fill-color"] = "#f2f2f2";
        } else if (l.type === "line") {
          if (/waterway|river/.test(id)) l.paint["line-color"] = "#dcdcdc";
          else if (/boundary|admin/.test(id)) l.paint["line-color"] = "#8c8c8c";
          else if (/casing/.test(id)) l.paint["line-color"] = "#c9c9c9";
          else if (/inner/.test(id)) l.paint["line-color"] = "#ffffff";
          else if (/subtle|path|minor|track|service/.test(id)) l.paint["line-color"] = "#e0e0e0";
          else if (/railway/.test(id)) l.paint["line-color"] = /dash/.test(id) ? "#ffffff" : "#cfcfcf";
          else if (/aeroway|pier/.test(id)) l.paint["line-color"] = "#e8e8e8";
        } else if (l.type === "symbol") {
          l.paint["text-color"] = "#2b2b2b";
    ...
    map.on("load", () => {
      ...
      map.addLayer({
        ...
        paint: {
          ...
          "circle-radius": ["interpolate", ["linear"], ["zoom"], 4, 5.5, 10, 6.5, 14, 8],
        },
      });
      map.addLayer({
